...
cifrar.addEventListener("click", function () {
  ...
  document.getElementById("cifrar").value=cipher.encode(offset, mensagemParaCifrar);
...
decifrar.addEventListener("click", function () {
  ...
  document.getElementById("decifrar").value=cipher.decode(offset, mensagemParaCifrar);
});
